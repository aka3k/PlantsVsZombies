...
public class Nemico {
    ...
    public Nemico(GamePanel parent,int lane){
        this.gp = parent;
        myLane = lane;
    }
    ...
    public static Nemico getZombie(String type,GamePanel parent, int lane) {
        Nemico z = new Nemico(parent,lane);
       switch(type) {
